...
def csvify_sex_machine_data 
    ...
    artist_image = "db/scraped_images/#{artist_name}.jpg"
    ...
    csv_file = "db/scraped_performances/#{artist_name}_newly_scraped_performances.csv"
    CSV.open(csv_file, "wb") do |csv|
        csv << [artist_name, artist_description, artist_image]
        csv << [performance_name, performance_address, performance_start_time, performance_end_time, performance_address_latitude, performance_address_longitude ]
    end
