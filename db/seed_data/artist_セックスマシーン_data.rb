...
def csvify_sex_machine_data 
    ...
    artist_image = "db/seed_data/artist_images/#{artist_name}.jpg"
    ...
    csv_file = "db/seed_data/artist_performances/#{artist_name}_newly_input_performances.csv"
    CSV.open(csv_file, "wb") do |csv|
        csv << [artist_name, artist_description, artist_image]
        artist_performances.each do |performance|
            csv << [artist_name, performance[:performance_name], performance[:performance_address], performance[:performance_start_time], performance[:performance_end_time], performance[:performance_address_latitude], performance[:performance_address_longitude] ]
        end
    end
